...
INSERT INTO `accountsettings` (`NickName`, `BudgetPerMonth`, `MonthStart`, `PremiumSavedMoney`) VALUES ('Flask',1000,1,NULL),('Hiirokasu',1000,1,NULL),('Konrad',1000,1,NULL),('Python',1000,1,NULL);
...
INSERT INTO `categories` (`SaleName`, `Category`) VALUES ('Python','Books'),('Skd','Books'),('Coffee','Drink'),('Hotdog','Food'),('Headphones','RTV');
...
INSERT INTO `favourites` (`NickName`, `FavouriteName`, `ShopID`, `Cost`, `Currency`) VALUES ('Flask','Zakupy',1,20,'PLN'),('Konrad','asd',1,0.11,'USD');
...
INSERT INTO `shopdetails` (`ShopName`, `Address`, `Country`, `City`) VALUES ('Asd','qweqe','Poland','Wroclaw'),('myTesco','Dluga Street','Poland','Wroclaw'),('Sks','Pwr','Poland','Wroclaw');
...
INSERT INTO `shops` (`ShopID`, `ShopName`) VALUES (3,'Asd'),(1,'myTesco'),(2,'Sks');
...
INSERT INTO `transactions` (`Transaction ID`, `Date`, `NickName`, `SaleName`, `MoneySpent`, `Currency`, `ShopID`) VALUES (1,'0000-00-00','Konrad','Skd',12,'PLN',1);
...
INSERT INTO `users` (`EMail`, `NickName`, `Type`) VALUES ('asdf@mail.com','Flask','Y'),('localhost@flaskmail.com','Hiirokasu','Z'),('cos@gmail.com','Python','N'),('abc@def.ij','Konrad','Y');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_currency`(name CHAR(3), fToPLN FLOAT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_favourite`(usernick VARCHAR(32), transactionname VARCHAR(64), price FLOAT, cCurrency CHAR(3), shop VARCHAR(64))
BEGIN
    IF (price<0)
      THEN
        SIGNAL SQLSTATE '45000'
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_routine`(ftime DATE, ltime DATE, dayy INT(11), usernick VARCHAR(32), transactionname VARCHAR(64), price FLOAT, cCurrency CHAR(3))
BEGIN
    IF (price<0)
      THEN
        SIGNAL SQLSTATE '45000'
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_transaction`(time DATE, usernick VARCHAR(32), transactionname VARCHAR(64), categoryname VARCHAR(32), price FLOAT, cCurrency CHAR(3), shop VARCHAR(64))
BEGIN
    IF (price<0)
      THEN
        SIGNAL SQLSTATE '45000'
...
/*!50003 SET collation_connection  = @saved_col_connection */ ;
ALTER DATABASE `tu_wpisz_tytul` CHARACTER SET utf8 COLLATE utf8_general_ci ;
/*!50003 DROP PROCEDURE IF EXISTS `get_budget` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_budget`(
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `set_account_settings`(nick VARCHAR(32), budget FLOAT, startofmonth INT(11))
BEGIN
...
/*!50003 SET collation_connection  = @saved_col_connection */ ;
ALTER DATABASE `tu_wpisz_tytul` CHARACTER SET utf8 COLLATE utf8_general_ci ;
/*!50003 DROP PROCEDURE IF EXISTS `show_fav` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `show_fav`(
IN nickuser VARCHAR(32)
)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `show_rout` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `show_rout`(
IN nickuser VARCHAR(32)
)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `show_shops` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `show_shops`(
)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `show_tran` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `show_tran`(
IN nickuser VARCHAR(32)
)
BEGIN
...
-- Dump completed on 2018-01-12 16:18:37
