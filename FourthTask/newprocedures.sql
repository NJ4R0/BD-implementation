...
BEGIN
  SELECT BudgetPerMonth, COUNT(MoneySpent) FROM accountsettings JOIN transactions ON accountsettings.NickName = transactions.NickName WHERE accountsettings.NickName = nickuser;
END$$
DELIMITER ;
